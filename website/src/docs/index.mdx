...
| **focusTrapOptions**    | `{ focusOn?: React.RefElement<HTMLDivElement> }`                                                                                                                                                                                       | undefined | Options for focus trap. Useful if you want to focus a different element when modal opens.                                                                                                                          |
